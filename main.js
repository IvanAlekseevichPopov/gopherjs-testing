...
$packages["github.com/oskca/gopherjs-vue/jscode/debug"] = (function() {
	var $pkg = {}, $init;
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
...
$packages["strings"] = (function() {
	var $pkg = {}, $init, errors, js, bytealg, io, unicode, utf8, HasPrefix;
	errors = $packages["errors"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	bytealg = $packages["internal/bytealg"];
	io = $packages["io"];
...
$packages["github.com/oskca/gopherjs-vue"] = (function() {
	...
	New = function(selectorOrHTMLElement, structPtr) {
		var _key, opt, selectorOrHTMLElement, structPtr, vm;
		opt = NewOption();
	...
	pool.init("github.com/oskca/gopherjs-vue", [{prop: "creator", name: "creator", embedded: false, exported: false, typ: funcType, tag: ""}, {prop: "structPtr", name: "structPtr", embedded: false, exported: false, typ: $emptyInterface, tag: ""}, {prop: "counter", name: "counter", embedded: false, exported: false, typ: $Int, tag: ""}]);
	...
	$init = function() {
		...
		$r = debug.$init(); /* */ $s = 4; case 4: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$packages["main"] = (function() {
	...
	Model.init("", [{prop: "Object", name: "Object", embedded: true, exported: true, typ: ptrType$1, tag: ""}, {prop: "IntValue", name: "IntValue", embedded: false, exported: true, typ: $Int, tag: "js:\"integer\""}, {prop: "Str", name: "Str", embedded: false, exported: true, typ: $String, tag: "js:\"str\""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
